...
public interface CartPickController {
	...
	//찜하기 장바구니 페이지에 추가 담기
	/*
	 * public ModelAndView addCart(@ModelAttribute("info") PickVO pickVO,
	 * HttpServletRequest request, HttpServletResponse response) throws Exception;
	*/
	public ModelAndView addCart(@ModelAttribute("info") CartAddVO cartAddVO, HttpServletRequest request, HttpServletResponse response) throws Exception;
