...
<link href="/Resources/User/Css/Notice/noticeEchoWrapFeedbackDetail.css"
...
<link
	...
	rel="stylesheet">
<!-- 파비콘 링크 -->
<link href="/Resource/User/Img/KurlyIcon.png" rel="icon"
	type="image/x-icon" />
...
<body>
	<div class="wrap">
			...
			<div class="content">
				<div class="title">
					...
					<span> 에코 박스에 대한 피드백이나 새로운 포장재에 대한 제안을 남겨주세요.<br /> 더욱 세심하게
						포장되었으면 하는 상품이 있다면 언제든 말씀주세요.<br /> 제안해 주신 의견은 담당자가 실시간으로 모니터링할
						예정이나 별도 답변 안내는 되지 않음을 양해 부탁드립니다.<br /> 배송관련, 주문(취소/교환/환불)관련 문의 및
						요청 사항은 1:1문의/카카오톡/고객센터(0000-0000)로 문의 바랍니다.<br />
					</span>
				</div>
				...
				<div class="writeBtn">
					<a href="/View/User/Notice/noticeEchoWrapFeedback.jsp">등록</a>
				</div>
			</div>
		...
		<%-- footer end--%>
		<script src="/Resources/User/Js/Notice/noticeEchoWrapFeedbackDetail.js"></script>
	</div>
</body>
</html>