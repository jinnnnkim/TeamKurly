...
<link href="/Resources/User/Css/Notice/frequencyQuestion.css"
...
<body>
	...
	<div class="wrap">
				...
				<div class="noticeTable">
					<table>
						...
						<tr>
							<td>88</td>
							<td>회원</td>
							<td class="cont detail88"><a href="#none">아이디 패스워드를 잊어버렸습니다.</a></td>
						</tr>

						<tr class="faq88">
							<td><img src="/Resources/User/Img/Notice/market1.gif"></td>
							<td class="cont" colspan='2'>■ 아이디, 비밀번호 찾기 안내<br> <br> <br> - 하기 경로를
								통해 아이디 및 비밀번호 찾기가 가능하며, 임시 비밀번호의 경우 회원가입 시 등록한 이메일 주소로 발송 됩니다.<br>
								<br> <br> (PC) 컬리홈 상단 [로그인] &gt; 화면 아래 [아이디 찾기] [비밀번호
								찾기]<br> <br> (모바일) 아래 탭에서 [마이컬리] &gt; 로그인 화면 아래 [아이디
								찾기] [비밀번호 찾기]<br> <br> <br> [참고]<br> <br>
								▣ 가입시 기재한 메일 주소가 기억나지 않으시거나 오류가 발생하는 경우 고객센터로 문의 바랍니다.<br>
								<br> ▣ 상담시에는 고객님의 개인정보보호를 위해 기존에 사용하시던 비밀번호는 안내가 불가하며, 개인정보
								확인 후 임시비밀번호를 설정해드립니다.
							</td>
						</tr>
		...
		<%-- footer end--%>
		<script src="/Resources/User/Js/Notice/frequencyQuestion.js"></script>
	</div>
</body>
</html>