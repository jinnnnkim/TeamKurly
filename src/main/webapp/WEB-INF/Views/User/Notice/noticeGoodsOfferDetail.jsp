...
<link href="/Resources/User/Css/Notice/noticeGoodsOfferDetail.css"
	...
	<div class="wrap">
		...
		<div class="main">
			...
			<div class="content">
						...
						<tr class="offerImg">
							...
							<td>
								...
								<div class="offerImgDiv2">	
									...
									<input id="fileUp" class="fileuploadRemove" type="button" value="업로드 삭제"/><br/>
								</div>
				...
				<div class="writeBtn">
					<a href="/View/User/Notice/noticeGoodsOffer.jsp">등록</a>
				</div>
			</div>
		...
		<%-- footer end--%>
		<script src="/Resources/User/Js/Notice/noticeGoodsOfferDetail.js"></script>
	</div>
</body>
</html>