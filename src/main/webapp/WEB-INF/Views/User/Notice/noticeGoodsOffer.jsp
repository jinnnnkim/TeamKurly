...
<link href="/Resources/User/Css/Notice/noticeGoodsOffer.css"
...
<body>
	<div class="wrap">
		...
		<div class="main">
			...
			<div class="content">
				<div class="title">
					<h2>상품제안</h2>
					<span>
					마켓컬리에서 추가적으로 판매되면 좋을 상품을 제안해주세요.<br/>
					고객님의 의견을 발 빠르게 반영하여 더욱 편리한 마켓컬리가 되겠습니다.<br/>
					주의)알콜 제품은 법령상 온라인 판매가 불가하오니, 이 점 참고하여 작성부탁드립니다.<br/>
					담당 MD가 제안해주신 의견을 실시간으로 모니터링할 예정이나, 별도 답변 안내는 되지 않음을 양해부탁드립니다.<br/>
					</span>
				</div>
				...
				<div class="writeBtn">
					<a href="/View/User/Notice/noticeGoodsOfferDetail.jsp">글쓰기</a>
				</div>
			</div>
		...
		<%-- footer end--%>
		<script src="/Resources/User/Js/Notice/noticeGoodsOffer.js"></script>
	</div>
</body>
</html>