...
<meta charset="UTF-8">
<title>배송지 관리</title>
<link rel="stylesheet" href="/Resources/User/Css/Mypage/mypageInfo.css" type="text/css">
<link href="/Resources/User/Css/Mypage/reset.css" rel="stylesheet" type="text/css">
<link href="/Resources/User/Css/Mypage/addresslist.css" rel="stylesheet" type="text/css">
<!-- fontawesome 링크 -->
<link rel="stylesheet"
...
<link
	...
	rel="stylesheet">
<!-- 파비콘 링크 -->
<link href="/Resources/User/Img/Mypage/KurlyIcon.png" rel="icon"
	type="image/x-icon" />
</head>
<body>
	<%--wrap --%>
			...
			<div class="content">
				<div class="address_main">
					<div class="head">
						...
						<a href="" class="address_search" onclick="window.open('');">+
							새 배송지 추가</a>
					</div>
					<!-- head -->
					...
					<table class="address_content">
						<tr>
							<td class="select_icon">
								...
								<img src="/Resources/User/Img/Mypage/ico_checkbox_checked.png">
							</td>
							<td class="address">
							...
							<td class="modify">
								<a href="" class="modify_pop" onclick="window.open('');">
								<img src="/Resources/User/Img/Mypage/ico_modify_x2.png"></a>
							</td>
						</tr>
					</table>
				</div>
