...
<head>
	...
	<link rel="stylesheet" href="../../../Resources/Admin/Css/UserSet/depositMail.css">
	<link rel="stylesheet" href="../../../Resources/Admin/Css/HomePageHeaderSide/reset.css">
	<script type="text/javascript" src="../../../Resources/SmartEditor/js/service/HuskyEZCreator.js" charset="utf-8"></script>
	<script type="text/javascript" src="http://code.jquery.com/jquery-latest.min.js"></script>
	<script type="text/javascript" src="../../../Resources/Admin/Js/UserSet/depositMail.js" charset="UTF-8"></script>
	...
	<div class="wrap">
		...
		<table class="table2">
			<tr>
				...
				<td class="whiteBg"><input id="text" type="text" value="주문하신 상품의 입금이 확인되었습니다."></td>
			</tr>
			<tr>
