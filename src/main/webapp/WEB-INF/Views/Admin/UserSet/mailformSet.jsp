...
<head>
	...
	<link rel="stylesheet" href="../../../Resources/Admin/Css/UserSet/mailformSet.css">
	<link rel="stylesheet" href="../../../Resources/Admin/Css/HomePageHeaderSide/reset.css">
	<script type="text/javascript" src="../../../Resources/SmartEditor/js/service/HuskyEZCreator.js" charset="utf-8"></script>
	<script type="text/javascript" src="http://code.jquery.com/jquery-latest.min.js"></script>
	<script type="text/javascript" src="../../../Resources/Admin/Js/UserSet/mailformSet.js" charset="UTF-8"></script>
	...
	<div class="wrap">
		...
		<table class="table2">
			<tr>
				...
				<td class="whiteBg"><input id="text" type="text" value="{이름}님 회원가입을 축하드립니다."></td>
			</tr>
			<tr>
		...
		<textarea id="mailContent" rows="10" cols="100" style="width: 100%">
			...
			<h3>
			가입해주셔서 대단히 감사합니다.<br>
			회원님의 모든 정보는 개인정보보호정책에 의해<br>
			안전하게 보호되고 있으니 안심하시고 다양한 서비스를 이용하시기 바랍니다.
			</h3>
			
			안녕하세요. {이름} 고객님.<br>
			고객님의 아이디/비밀번호는 아래와 같습니다. <br>
			<hr>
			...
			위 비밀번호는 암호화전의 비밀번호이며, 실제 사이트에서는 암호화되어 안전하게 보관됩니다. <br>
			
			아이디나 비밀번호를 분실하셨을 경우 아이디/비밀번호 찾기 버튼을 클릭하셔서 확인하시거나 <br>
			이메일을 주시면 본인 확인 후 신속히 안내해드리겠습니다. <br>
			이상이 있거나 불편사항 및 문의사항이 있으시면 <b>고객센터</b>로 문의해주세요.
			
			<button class="gositeBtn">사이트 바로가기</button> <br><br>
			
			회원님의 회원정보 메일수신동의 여부에 수신동의가 되어있기에 본 메일이 발송되었습니다.<br>
