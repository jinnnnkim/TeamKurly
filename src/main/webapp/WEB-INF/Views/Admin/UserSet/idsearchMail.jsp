...
<head>
	...
	<link rel="stylesheet" href="../../../Resources/Admin/Css/UserSet/idsearchMail.css">
	<link rel="stylesheet" href="../../../Resources/Admin/Css/HomePageHeaderSide/reset.css">
	<script type="text/javascript" src="../../../Resources/SmartEditor/js/service/HuskyEZCreator.js" charset="utf-8"></script>
	<script type="text/javascript" src="http://code.jquery.com/jquery-latest.min.js"></script>
	<script type="text/javascript" src="../../../Resources/Admin/Js/UserSet/idsearchMail.js" charset="UTF-8"></script>
	...
	<div class="wrap">
		...
		<table class="table2">
			<tr>
				...
				<td class="whiteBg"><input id="text" type="text" value="{이름}님 안녕하세요. 요청하신 ID입니다."></td>
			</tr>
			<tr>
