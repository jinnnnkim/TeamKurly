...
<head>
	...
	<link rel="stylesheet" href="../../../Resources/Admin/Css/UserSet/deliMail.css">
	<link rel="stylesheet" href="../../../Resources/Admin/Css/HomePageHeaderSide/reset.css">
	<script type="text/javascript" src="../../../Resources/SmartEditor/js/service/HuskyEZCreator.js" charset="utf-8"></script>
	<script type="text/javascript" src="http://code.jquery.com/jquery-latest.min.js"></script>
	<script type="text/javascript" src="../../../Resources/Admin/Js/UserSet/deliMail.js" charset="UTF-8"></script>
	...
	<div class="wrap">
		...
		<table class="table2">
			<tr>
				...
				<td class="whiteBg"><input id="text" type="text" value="주문하신 상품이 발송되었습니다."></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="whiteBg">
					...
					<!-- 버튼 클릭시 창 내려오는 부트스트랩 구현 ★버튼 위치 조정 필요 -->
