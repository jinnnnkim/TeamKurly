			...
			<td align="left">
				...
				<table class="table table1 table_line">
					...
					<tr>
						...
						<td colspan="3" style="text-align: left;">
							...
							<label class="lbl">
							<input type="checkbox" name="status[]" value="complete" checked/>배송완료
							</label>
							<label class="lbl">
				...
				<div class="list-tools">
					<div class="list-action">
						...
						<button id="del_info_upload" class="btn btn-Li_blue">배송정보 업로드</button>
					</div>
					<div class="summary">
						검색된 주문
						<span class="f-bold f-red f-num">1</span>
						건
						<span>|</span>
						총 주문
					...
					<tr>	<!-- 필요시 value값 적절히 수정하기 -->
						...
						<td style="text-align: left; padding: 10px;">
							...
							<a href="orderInfoDetail.jsp">
								병아리 우주복외 1건
								<span class="helper" title="주문번호">[G9B9D7_1470284403]</span>
							</a>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >주문일시 : 2020-11-23 13:20</span>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >결제일시 : 2016-08-04 13:20</span>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >배송완료일 : -0001-11-30 00:00</span>
							</div>
						</td>
						<td>
							207,500원
							<div class="f-small f-gray" style="margin: 5px 0px">배송비 : 6,000원</div>
						</td>
						<td>무통장입금</td>
						<td><!-- 적절한 id값으로 수정하기 -->
							<select id="status_44">
