				...
				<table class="table table1 table_line">
					...
					<tr>
						...
						<td colspan="3" style="text-align: left;">
							...
							<label class="lbl">
							<input type="checkbox" name="status[]" value="prepare" checked/>발송준비중
							</label>
							<label class="lbl">
					...
					<tr>	<!-- 필요시 value값 적절히 수정하기 -->
						...
						<td style="text-align: left; padding: 10px;">
							...
							<a href="orderInfoDetail.jsp">
								병아리 우주복외 2건
								<span class="helper" title="주문번호">[G49B3B_1470284596]</span>
							</a>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >주문일시 : 2020-11-23 13:23</span>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >결제일시 : 2016-08-04 13:23</span>
							</div>
						</td>
						<td>
							145,000원
							<div class="f-small f-gray" style="margin: 5px 0px">배송비 : 9,000원</div>
						</td>
						<td>무통장입금</td>
						<td><!-- 적절한 id값으로 수정하기 -->
							<select id="status_44">
								...
								<option value="prepare" selected>발송준비중</option>
