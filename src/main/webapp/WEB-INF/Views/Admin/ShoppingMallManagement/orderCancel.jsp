			...
			<td align="left">
				...
				<table class="table table1 table_line">
					...
					<tr>
						...
						<td colspan="3" style="text-align: left;">
							<label class="lbl">
							<input type="checkbox" name="status[]" value="ready"/>임금대기
							</label>
							<label class="lbl">
							...
							<label class="lbl">
							<input type="checkbox" name="status[]" value="cancel" checked/>주문취소
							</label>
						</td>
					</tr>
					<tr>
				...
				<div class="list-tools">
					<div class="list-action">
						<!-- 버튼클리시 나타나는 기능 넣기 -> 각각버튼에 onclick기능 넣기 -->
					...
					<div class="summary">
						검색된 주문
						<span class="f-bold f-red f-num">2</span>
						건
						<span>|</span>
						총 주문
				...
				<table class="table table1 list_top table_line table-center">
					...
					<tr>	<!-- 필요시 value값 적절히 수정하기 -->
						...
						<td style="text-align: left; padding: 10px;">
							...
							<a href="orderInfoDetail.jsp">
								병아리 우주복외 7건
								<span class="helper" title="주문번호">[RANKUP_1470286482]</span>
							</a>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >주문일시 : 2020-11-23 13:54</span>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >취소일시 : -0001-11-30 00:00</span>
							</div>
						</td>
						<td>
							204,000원
							<div class="f-small f-gray" style="margin: 5px 0px">배송비 : 18,000원</div>
						</td>
						<td>무통장입금</td>
						<td><!-- 적절한 id값으로 수정하기 -->
							<select id="status_44">
					...
					<tr>	<!-- 필요시 value값 적절히 수정하기 -->
						...
						<td style="text-align: left; padding: 10px;">
							...
							<a href="orderInfoDetail.jsp">
								악어 우주복
								<span class="helper" title="주문번호">[GCA3FE_1470284648]</span>
							</a>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >주문일시 : 2020-11-23 13:17</span>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >취소일시 : 2016-08-04 13:24</span>
							</div>
						</td>
						<td>
							63,000원
