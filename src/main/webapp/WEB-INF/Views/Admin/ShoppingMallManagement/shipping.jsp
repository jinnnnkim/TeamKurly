				...
				<table class="table table1 table_line">
					...
					<tr>
						...
						<td colspan="3" style="text-align: left;">
							...
							<label class="lbl">
							<input type="checkbox" name="status[]" value="delivery" checked/>배송중
							</label>
							<label class="lbl">
				...
				<table class="table table1 list_top table_line table-center">
					...
					<tr>	<!-- 필요시 value값 적절히 수정하기 -->
						...
						<td style="text-align: left; padding: 10px;">
							<div><!--  <a>태그 주문상세정보 페이지로 이동하는 기능 넣기-->
							<a href="orderInfoDetail.jsp">
								악어우주복
								<span class="helper" title="주문번호">[G79953_1470284492]</span>
							</a>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >주문일시 : 2020-11-23 13:21</span>
							</div>
							<div class="hline">
								<span class="f-small f-gray" >결제일시 : 2016-08-04 13:21</span>
							</div>
						</td>
						<td>
							68,000원
