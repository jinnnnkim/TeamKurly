...
<body>
						...
						<table class="table1 addTable table_line">
							...
							<tbody>
								...
								<select class="category1">
									<option>${cate1Array.cateName }</option>
								</select>
								
								<label>2차 분류</label>
								<select class="category2">
									<option>${cate2Array.cateName }</option>
								</select>
								
								<label>3차 분류</label>
								<select class="category3" name="cateCode">
									<option>${cate3Array.cateName }</option>
								</select>
								</td>
								</tr>
								<tr>
	...
	let showCate2 = '';
	let showCate = '${prodVO.cateCode}';
	
	/* 3차 분류 */
	for(let i=0; i<cate3Array.length; i++){
		if(showCate3 == cate3Array[i].cateName){
			showCate3 = cate3Array[i];
		}
	} //for
	
	for(let i = 0; i < cate3Array.length; i++){
		if(showCate3.cateParent == cate3Array[i].cateParent){
			cateSelect3.append("<option value='"+cate3Array[i].cateName+"'>" + cate3Array[i].cateName + "</option>");	
		}
	}
	
	$(".category3 option").each(function(i, obj){
		if(showCate3.cateName == obj.value){
	...
	for(let i=0; i<cate2Array.length; i++){
		if(showCate3.cateParent == cate2Array[i].cateName){
			showCate2 = cate2Array[i];
		}
	}//for
	
	for(let i=0; i<cate2Array.length; i++){
		if(showCate2.cateParent == cate2Array[i].cateParent){
			cateSelect2.append("<option value='"+cate2Array[i].cateName+"'>" + cate2Array[i].cateName + "</option>");	
		}
	}
	
	$(".category3 option").each(function(i, obj){
		if(showCate2.cateName == obj.value){
			$(obj).attr("selected", "selected");
		}	
	});
	...
	$(".category1 option").each(function(i, obj){
		if(showCate2.cateName == obj.value){
			$(obj).attr("selected", "selected");
		}	
	});
