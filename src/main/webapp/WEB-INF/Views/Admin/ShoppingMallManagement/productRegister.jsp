...
<head>
	...
	<link rel="stylesheet" href="../../../Resources/Admin/Css/ShoppingMallManagement/productRegister.css">
					...
					<form id="goodsSearchFrm" action="" onsubmit="return false">
						...
						<table class="table1 addTable table_line">
							...
							<tbody>
								...
								<td><!-- onchange기능 넣기 value="값넣기" / 1차분류 선택시 2차분류가 보이는 기능 넣기-->
									<select name="cate1" id="shop_1" onchange="" >
									<option value>1차분류</option>
									<option value="">패션의류</option>
									<option value="">아동용품</option>
									<option value="">식품</option>
									<option value="">문구/오피스</option>
									<option value="">잡화/뷰티</option>
									<option value="">가구/홈/데코</option>
									<option value="">가전/디지털</option>
									<option value="">도서/취미</option>
									<option value="">반려동물용품</option>
									<option value="">여행/레저</option>
									<option value="">온라인쿠폰/상품권</option>
									</select>
									<!-- onchange기능 넣기 value="값넣기" / 2차분류 선택시 2차분류가 보이는 기능 넣기-->
									<select name="cate1" id="shop_1" onchange="" >
									<option value>2차분류</option>
									<option value="">여성상의</option>
									<option value="">여성하의</option>
									<option value="">남성상의</option>
									<option value="">남성하의</option>
									<option value="">언더웨어/잠옷</option>
									</select>
									<!-- onchange기능 넣기 value="값넣기" -->
									<select name="cate3" id="shop_3" onchange="" >
									<option value>3차분류</option>
									<option value="">패딩/점퍼</option>
									<option value="">코트/재킷</option>
									<option value="">니트/가디건</option>
									<option value="">맨투맨/후드/집업</option>
									<option value="">티셔트</option>
						...
						<table id="popupGoodsTable" class="table1 addTable table_line ">
							...
							<tr>
								<td align="center" class="shop_img"> 
									<img src="../../../Resources/Admin/Img/ShoppingMallManagement/b_Tea.png" width="100" height="80">
								</td>
				...
				<div class="main-content">
					...
					<table class="table table1 line_top table_line">
						...
						<tbody>
							<tr>
								...
								<td>
									<select name="">
											...
											<option value="3">아동용품</option>
											<option value="4">식품</option>
											<option value="5">문구/오피스</option>
											<option value="6">잡화/뷰티</option>
											<option value="7">가구/홀/데코</option>
											<option value="8">가전/디지털</option>
											<option value="9">도서/취미</option>
											<option value="10">반려동물용품</option>
											<option value="11">여행/레저</option>
											<option value="12">온라인쿠폰/상품권</option>
									</select>
									<select name="">
											<option value>2차분류</option>
											...
											<option value="5">커튼/블라인드</option>
											<option value="6">가펫/매트</option>
											<option value="7">화분/액자/기타소품</option>
									</select>
							...
							<tr>
								<th>상품명</th>
								<td><input type="text" value="체중계"/></td>
							</tr>
							<tr>
								<th>간단설명</th>
								<td>
									<input type="text" value="스마트체중계"/>
									<div class="helper blue mt5">
								...
								<td>
									...
									<ul id="file_list" class="ui-sortable">
										<li class="ui-sortable-handle">
											<div class="img-body">
												<img src="../../../Resources/Admin/Img/ShoppingMallManagement/scale.png" width="100px" height="80px">
									...
									<div class="helper red mt5">
										<img src="../../../Resources/Admin/Img/ShoppingMallManagement/Question-red2.png" width="15px" height="15px">
										파일삭제시 바로 적용됩니다.
									</div>
								</td>
							</tr>
							...
							<tr>
								<th>적립금</th>
								<td>
									<input style="width: 80px; text-align: center;" type="text" name="milege"  value="0"/>
									<select name="milege_type">
										<option value="0">선택하세요</option>
										<option value="default">기본지급정책적용</option>
										<option value="self">직접입력</option>
										<option value="1">판매금액의 1%</option>
										<option value="2">판매금액의 2%</option>
										<option value="3">판매금액의 3%</option>
										<option value="4">판매금액의 4%</option>
										<option value="5">판매금액의 5%</option>
										<option value="6">판매금액의 6%</option>
										<option value="7">판매금액의 7%</option>
										<option value="8">판매금액의 8%</option>
										<option value="9">판매금액의 9%</option>
										<option value="10">판매금액의 10%</option>
										<option value="11">판매금액의 11%</option>
										<option value="12">판매금액의 12%</option>
										<option value="13">판매금액의 13%</option>
										<option value="14">판매금액의 14%</option>
										<option value="15">판매금액의 15%</option>
										<option value="16">판매금액의 16%</option>
										<option value="17">판매금액의 17%</option>
										<option value="18">판매금액의 18%</option>
										<option value="19">판매금액의 19%</option>
										<option value="20">판매금액의 20%</option>
									</select>
									<div class="helper blue mt5">
										<img src="../../../Resources/Admin/Img/ShoppingMallManagement/Question-blue.png" width="12px" height="12px">
										상품별 적립금 설정이 가능합니다.
					...
					<div class="option_fram">
						<div class="sub-title" style="margin-top: 20px">
							...
							<span class="helper red mt5">
								<img src="../../../Resources/Admin/Img/ShoppingMallManagement/Question-red1.png" width="15px" height="15px">
						...
						<table class="table table1 table_line">
							...
							<tbody class="al_middle">
								<tr>
									...
									<td rowspan="3">
										<!-- href기능 넣기 -->
										<a href="#"><img src="../../../Resources/Admin/Img/ShoppingMallManagement/trash-can.png" width="20px" height="20px"></a>
									</td>
								</tr>
								<tr>
									<td>
