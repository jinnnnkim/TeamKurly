				...
				<table class="table table1 table_line">
					...
					<tr>
						...
						<td colspan="3" style="text-align: left;">
							...
							<label class="lbl">
							<input type="checkbox" name="status[]" value="payed" checked/>결제완료
							</label>
							<label class="lbl">
					...
					<tr>	<!-- 필요시 value값 적절히 수정하기 -->
						...
						<td style="text-align: left; padding: 10px;">
							...
							<a href="orderInfoDetail.jsp">
								악어우주복
								<span class="helper" title="주문번호">[G8B229_1470284261]</span>
							</a>
							</div>
							<div class="hline">
							...
							<div class="hline">
								<span class="f-small f-gray" >결제일시 : 2016-08-04 13:17</span>
							</div>
						</td>
						<td>
							350,000원
							<div class="f-small f-gray" style="margin: 5px 0px">배송비 : 0원</div>
						</td>
						<td>무통장입금</td>
						<td><!-- 적절한 id값으로 수정하기 -->
							<select id="status_44">
								<option value="ready">입금대기</option>
								<option value="payed" selected>결제완료</option>
					...
					<form name="RUFrmCsvUpload" id="RUFrmCsvUpload" action="">
						...
						<tr>
							...
							<div class="file_div">
								...
								<!-- onchange기능 넣기 (선택클릭시 파일을 선택할 수 있는 창이 나타나도록 기능 추가하기)-->
