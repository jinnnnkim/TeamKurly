			...
			<div class="wrap_content">
				...
				<div class="leftContent">
					...
					<div class="messageImg">
						<img alt="문자" src="../../../Resources/Admin/Img/Sms/half_msg.png"><br>
				...
				<div class="bottomContent">
					...
					<!-- 팝업창 이벤트 구현 -->
					<a href="smsPopup.jsp" onclick="window.open(this.href,'팝업창','width=400, height=500'); return false;">
					<button class="viewBtn">발송될 핸드폰번호보기</button><br>
					</a>
					
					<!-- ★랭크업에서는 실제 문자 보내는 기능이 들어 있어서 추후 확인 필요 -->
					<a href="msgPopup.jsp" onclick="window.open(this.href,'팝업창','width=240, height=500'); return false;">
