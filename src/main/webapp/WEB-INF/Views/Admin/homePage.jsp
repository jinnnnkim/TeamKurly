...
<head>
	...
	<link rel="stylesheet" href="../../../resources/Admin/Css/homePage.css">
	<link rel="stylesheet" href="../../../resources/Admin/Css/reset.css">
	<script src="../../../../resources/Admin/Js/homePage.js"></script>
	...
	<div class="wrap">
		...
		<div class="homePageMain">
			...
			<!-- 동적 jsp:include를 사용해서 부모 jsp 파일에 자식 jsp를 불러왔음
			 ...
			 -->
			<jsp:include page="Point/pointRecord.jsp" flush="true"/>
		</div>
	</div>
</body>
</html>